	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${ctx }/removeDocument.action?docIds="+ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	...
			  	<!-- 配置pageNow的隐藏域 -->
					<input type="hidden" name="pageNow" value="${pb.pageNow }" id="pageNow">
	  ...
	  <tr valign="top">
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${pb.list}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" name="docIds" value="${document.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${ctx }/updateDocumentJsp.action?id=${document.id}">
