	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				...
				<img src="${ctx }/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：文档管理  &gt; 文档修改
				</td>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" action="${ctx}/updateDocument.action?user_id=${sessionScope.user_session.id }" enctype="multipart/form-data" method="post">
                        <!-- 隐藏表单，flag表示添加标记 -->
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
						...
						<tr><td class="font3 fftd">
								<input type="button" name="sub" id="btn" value="修改">
