	  ...
	  <tr valign="top">
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${pb.list }" var="employee" varStatus="stat">
				<tr id="data_${stat.index }" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index }" name="empIds" value="${employee.id }"></td>
					 <td>${employee.name }</td>
					  <td>
					        <c:choose>
					  ...
					  <td align="center" width="40px;"><a href="${ctx}/updateEmployeeJsp.action?id=${employee.id }">
